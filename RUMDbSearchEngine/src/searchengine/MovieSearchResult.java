...
public class MovieSearchResult implements Comparable<MovieSearchResult> {
    ...
    {
        String movie = "Movie Title: " + this.title + "\nMinimum Distance: " + this.minDistance + "\n";
        for(Integer a: this.wordALocations)
        {
            movie = movie + a + ", ";
        }
        movie = movie + "END OF A";
        for(Integer b: this.wordBLocations)
        {
            movie = movie + b + ", ";
        }
        movie = movie + "\n";
