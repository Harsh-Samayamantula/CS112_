...
public class Driver {
    ...
    public static void main (String[] args) {
        ...
        ArrayList<MovieSearchResult> test = rudb.createMovieSearchResult(word1, word2);
        StdOut.print(test.size());
        
        for(MovieSearchResult movie: test)
        {
            StdOut.print(movie);
        }

        WordOccurrence wealthy = rudb.getWordOccurrence("wealthy");
        StdOut.print(wealthy);
